    ...
    <div :class="{ 'page-right': true, 'right': !Isjc, 'left': Isjc }">
      ...
      <div class="cart-jt-box" style="border: none; background: none;">
        ...
        <div class="cart-lbt" @wheel="handleScroll" ref="scrollableDiv">
          ...
          <div class="cart-lbt-cartx" v-for="i in home_data.home_lbt_list" :key="i.id" @click="util.desc(i.id)">
            <div class="right-top-box">
              <img v-lazy="i.url" alt="">
              <div class="zz">
                {{ i.xxtilte }}
              </div>
            </div>
      ...
      <Cart @click="util.desc(i.id)" v-for="i in Data" :data="i" :key="i.id"></Cart>
      <!-- 分页 -->
