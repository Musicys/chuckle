...
<div class="cart-desc" :class="!Ispc?'':Iswart?'hs-left':'hs-right'"  >
    <div  :class="{'desc-top':true,'right':Iswart&&Ispc,'left':!Iswart&&Ispc}" >
    <img v-lazy="data.url" alt="">
    </div>
    <div :class="{'desc-but':true,'right':!Iswart&&Ispc,'left':Iswart&&Ispc}" >
        
        <div class="but-bt">标题</div>
        <div>
    ...
    <div class="yc">记录各个方面、各种编码相关的零碎操作</div>
