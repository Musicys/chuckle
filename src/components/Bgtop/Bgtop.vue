...
<template>
    <div :class="{'bar-top': true, 'top-two': IsScroll,'top-two2':!IsScroll}">
           <div class="box">
            <div class="top-box">

                  
                        <el-icon class="router"   ><Operation /></el-icon>
                    ...
                    <div class="router-tab" v-if="Ispc">
                        ...
                        <div class="top-sc"  @click="setIsTab()">      
                            ...
                            <transition name="fades-slide" @before-enter="beforeEnter" @enter="enter" @leave="leave">
...
.fade-slides-enter-active, .fades-slide-leave-active {
  transition: opacity 0.5s ease, transform 0.5s ease;
  opacity: 0;
  transform: translateY(20px);
}

.fades-slide-enter-from, .fades-slide-leave-to {
  opacity: 0;
  transform: translateY(20px);
  transition: opacity 0.5s ease, transform 0.5s ease;
}
